...
public class Main
{
    public static void main(String args[])
    {
        ...
        System.out.println("Welcome to Guess Number game.Game \nYou Will Be Asked To Guess A Number To Win The game.Game \nYou have Maximum 5 Attemp Limit");
        do {
            ...
            if(userInput.hasNextInt()) {
                ...
                {
                    System.out.println("OOhhOO!, Your Number is Correct. You Win the game.Game!");
                    break;
                }
